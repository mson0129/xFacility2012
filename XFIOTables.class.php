...
//2013
	//Require_once
	require_once ($_SERVER['DOCUMENT_ROOT'].'/xfacility2012/classes/XFIO/XFDB.class.php');
	
	//Class
	class XFIOTables extends XFObject {
	var $no;
	var $application;
	var $xfArray; //Not Class, Just Array
	
	function XFIOTables($application) {
